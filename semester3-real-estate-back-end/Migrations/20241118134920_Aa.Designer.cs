            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Category 1",
                            UpdatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4599)
                        },
                        new
                        {
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9593",
                            Name = "Category 2",
                            UpdatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4610)
                        });
                });
            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Property", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bedroom = 1,
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9592",
                            CreatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4917),
                            ...
                            UpdatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4918),
                            UserId = "70acc54a-44e0-4d31-8b07-52b5b82e9e55",
                            ViewCount = 0,
                        ...
                        new
                        {
                            ...
                            Bedroom = 1,
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9592",
                            CreatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4922),
                            Description = "Description",
                            DirectionId = "ffe56d39-3939-4c5c-ade9-8f147dca9593",
                            Floor = 1,
                            JuridicalId = "ffe56d39-3939-4c5c-ade9-8f147dca9594",
                            ...
                            UpdatedAt = new DateTime(2024, 11, 18, 20, 49, 19, 615, DateTimeKind.Local).AddTicks(4922),
                            UserId = "70acc54a-44e0-4d31-8b07-52b5b82e9e55",
                            ViewCount = 0,
            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "ead87de4-a487-4fe9-b986-b05b318abbbd",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "fd3b0b8d-e962-43f4-a2a8-e68c024380a2",
