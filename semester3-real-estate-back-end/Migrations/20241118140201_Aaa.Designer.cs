            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Category 1",
                            UpdatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6075)
                        },
                        new
                        {
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9593",
                            Name = "Category 2",
                            UpdatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6088)
                        });
                });
            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Property", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Bedroom = 1,
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9592",
                            CreatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6410),
                            ...
                            UpdatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6411),
                            UserId = "70acc54a-44e0-4d31-8b07-52b5b82e9e55",
                            ViewCount = 0,
                        ...
                        new
                        {
                            ...
                            Bedroom = 1,
                            CategoryId = "ffe56d39-3939-4c5c-ade9-8f147dca9592",
                            CreatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6414),
                            Description = "Description",
                            DirectionId = "ffe56d39-3939-4c5c-ade9-8f147dca9594",
                            Floor = 1,
                            JuridicalId = "ffe56d39-3939-4c5c-ade9-8f147dca9594",
                            ...
                            UpdatedAt = new DateTime(2024, 11, 18, 21, 2, 1, 20, DateTimeKind.Local).AddTicks(6415),
                            UserId = "70acc54a-44e0-4d31-8b07-52b5b82e9e55",
                            ViewCount = 0,
            ...
            modelBuilder.Entity("semester3_real_estate_back_end.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "26022a8f-66f5-4537-adbf-2e68b9cc2e61",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "43009a98-f17b-42e3-b973-261cd950ba2d",
